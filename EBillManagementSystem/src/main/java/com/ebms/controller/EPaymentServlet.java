...
/**
 * Servlet implementation class EPaymentServlet
 */
public class EPaymentServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
	private static final Logger logger = LogManager.getLogger(EPaymentServlet.class);
    public EPaymentServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(count!=0)
		{
			...
			pw.println("<ul>");
			pw.println("<li width=250px height=40px text-align=center><a href=EPaymentViewServlet>ViewPayments</a></li>");
			pw.println("<li width=250px height=40px text-align=center><a href=epayment.html>Add payments</a></li>");
			pw.println("</ul>");
		}
		else
		{
