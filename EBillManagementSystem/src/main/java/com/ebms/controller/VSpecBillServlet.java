...
/**
 * Servlet implementation class VSpecBillServlet
 */
public class VSpecBillServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public VSpecBillServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{
			out.println("<div>");
			request.getRequestDispatcher("viewspecbill.html").include(request, response);
			out.println("</div>");
			out.println("<div>");
			out.println("Customer Service Id not found");
			out.println("</div>");
