...
/**
 * Servlet implementation class EViewAllBillsServlet
 */
public class EViewAllBillsServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public EViewAllBillsServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<tr><th>Bid</th><th>date</th><th>Cid</th><th>Cname</th><th>Cadd</th><th>Csid</th><th>Ctype</th><th>Cmobile</th><th>Units</th><th>Total Bill</th><th>Bill Status</th><th><form action='EVSpecBillServlet' method='get'><input type='text' name='csid'/><input type='submit' value='search'/></form></th><th></th></tr>");
